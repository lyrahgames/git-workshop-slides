...
\label{sec:basics}
  ...
  \begin{frame}{Basics: Distributed Version Control}
    \centering
    \only<1>{\includegraphics[height=0.8\textheight]{images/centralized.png}}
    \only<2>{\includegraphics[height=0.8\textheight]{images/distributed.png}}
  ...
  \begin{frame}{Basics: Snapshots}
    \centering
    \only<1>{\includegraphics[width=0.8\linewidth]{images/deltas.png}}
    \only<2>{\includegraphics[width=0.8\linewidth]{images/snapshots.png}}
